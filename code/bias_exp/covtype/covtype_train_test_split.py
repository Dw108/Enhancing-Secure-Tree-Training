...
# 无重叠数据
with open("../../../dataset/test/covtype_train.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name)
    csv_writer.writerows(arr_train)
    f.close()
with open("../../../dataset/test/covtype_validate.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name)
    csv_writer.writerows(arr_validate)
    f.close()
with open("../../../dataset/test/covtype_test.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name)
...
for i in range(len(arr_train)):
    ...
    tmp = np.insert(tmp, 2, float(tmp[1]) + np.random.laplace(loc=0, scale=100/1))
...
with open("../../../dataset/test/covtype_sub_feature_train.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name_feature)
    csv_writer.writerows(train_sub_feature)
    f.close()
with open("../../../dataset/test/covtype_sub_feature_validate.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name_feature)
    csv_writer.writerows(validate_sub_feature)
    f.close()
with open("../../../dataset/test/covtype_sub_feature_test.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name_feature)
...
for i in range(len(arr_train)):
    ...
    tmp[1] = float(tmp[1]) + np.random.laplace(loc=0, scale=100/1)
...
with open("../../../dataset/test/covtype_sub_item_train.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name)
    csv_writer.writerows(arr_train)
    f.close()
with open("../../../dataset/test/covtype_sub_item_validate.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name)
    csv_writer.writerows(arr_validate)
    f.close()

with open("../../../dataset/test/covtype_sub_item_test.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name)
    csv_writer.writerows(arr_test)
    f.close()
