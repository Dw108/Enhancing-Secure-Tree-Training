...
def sub_feature(name, arr_train, arr_validate, arr_test, scale1, scale2):
    ...
    # 分裂属性
    # 未加密
    write_data("../../../dataset/bias/covtype/covtype_sub_feature_train" + str(scale1) + '_' + str(scale2) + ".csv",
               name_feature, train_sub_feature_1)

    write_data("../../../dataset/bias/covtype/covtype_sub_feature_validate" + str(scale1) + '_' + str(scale2) + ".csv",
               name_feature, validate_sub_feature_1)
    write_data("../../../dataset/bias/covtype/covtype_sub_feature_test" + str(scale1) + '_' + str(scale2) + ".csv",
               name_feature, test_sub_feature_1)
    # 加密
    uni_data_1_1 = cols_enc([train_sub_feature_1, validate_sub_feature_1, test_sub_feature_1])
    write_data("../../../dataset/bias/covtype/covtype_sub_feature_train_enc" + str(scale1) + '_' + str(scale2) + ".csv",
               name_feature, uni_data_1_1[0])
    write_data("../../../dataset/bias/covtype/covtype_sub_feature_validate_enc" + str(scale1) + '_' + str(scale2) + ".csv",
               name_feature, uni_data_1_1[1])
    write_data("../../../dataset/bias/covtype/covtype_sub_feature_test_enc" + str(scale1) + '_' + str(scale2) + ".csv",
...
def sub_item(name, arr_train, arr_validate, arr_test, scale1, scale2):
    ...
    # 分裂条目
    # 未加密
    write_data("../../../dataset/bias/covtype/covtype_sub_item_train" + str(scale1) + '_' + str(scale2) + ".csv", name, arr_train_tmp)
    write_data("../../../dataset/bias/covtype/covtype_sub_item_validate" + str(scale1) + '_' + str(scale2) + ".csv", name, arr_validate_tmp)
    write_data("../../../dataset/bias/covtype/covtype_sub_item_test" + str(scale1) + '_' + str(scale2) + ".csv", name, arr_test_tmp)

    # 加密
    uni_data_2 = cols_enc([arr_train_tmp, arr_validate_tmp, arr_test_tmp])
    write_data("../../../dataset/bias/covtype/covtype_sub_item_train_enc" + str(scale1) + '_' + str(scale2) + ".csv", name, uni_data_2[0])
    write_data("../../../dataset/bias/covtype/covtype_sub_item_validate_enc" + str(scale1) + '_' + str(scale2) + ".csv", name, uni_data_2[1])
    write_data("../../../dataset/bias/covtype/covtype_sub_item_test_enc" + str(scale1) + '_' + str(scale2) + ".csv", name, uni_data_2[2])
def cols_enc(data):
    # data全维度数据
    cols_train = []
    cols_val = []
