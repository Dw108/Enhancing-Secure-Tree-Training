...
# 分裂条目方式的数据
df = read_csv("../../../dataset/test/pen_sub_item_train.csv")
data = df.values
X_train_item = data[:, 1:17]
X_train_item_ = data[:, 0:1]
y_train_item = data[:, -1]

df = read_csv("../../../dataset/test/pen_sub_item_validate.csv")
data = df.values
X_validate_item = data[:, 1:17]
X_validate_item_ = data[:, 0:1]
y_validate_item = data[:, -1]

df = read_csv("../../../dataset/test/pen_sub_item_test.csv")
data = df.values
