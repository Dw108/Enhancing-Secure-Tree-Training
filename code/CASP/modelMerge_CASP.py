...
df = read_csv("../../dataset/bias/"+name_file+"/"+name_file+"_sub_feature_train"+enc+scale+".csv")
data = df.values
X_train_single_1 = np.concatenate((data[:, 1:3].astype(int), data[:, 4:6].astype(int), data[:, 7:12].astype(int)), axis=1)
X_train_single_2 = np.concatenate((data[:, 1:3].astype(int), data[:, 4:5].astype(int), data[:, 6:12].astype(int)), axis=1)
X_train_single_3 = np.concatenate((data[:, 1:2].astype(int), data[:, 3:6].astype(int), data[:, 7:12].astype(int)), axis=1)
X_train_single_4 = np.concatenate((data[:, 1:2].astype(int), data[:, 3:5].astype(int), data[:, 6:12].astype(int)), axis=1)
X_train_single_ = data[:, 0:1].astype(int)
y_train_single = data[:, -1].astype(int)

df = read_csv("../../dataset/bias/"+name_file+"/"+name_file+"_sub_feature_validate"+enc+scale+".csv")
data = df.values
X_validate_single_1 = np.concatenate((data[:, 1:3].astype(int), data[:, 4:6].astype(int), data[:, 7:12].astype(int)), axis=1)
X_validate_single_2 = np.concatenate((data[:, 1:3].astype(int), data[:, 4:5].astype(int), data[:, 6:12].astype(int)), axis=1)
X_validate_single_3 = np.concatenate((data[:, 1:2].astype(int), data[:, 3:6].astype(int), data[:, 7:12].astype(int)), axis=1)
X_validate_single_4 = np.concatenate((data[:, 1:2].astype(int), data[:, 3:5].astype(int), data[:, 6:12].astype(int)), axis=1)
...
df = read_csv("../../dataset/bias/"+name_file+"/"+name_file+"_sub_feature_test"+enc+scale+".csv")
data = df.values
X_test_single_1 = np.concatenate((data[:, 1:3].astype(int), data[:, 4:6].astype(int), data[:, 7:12].astype(int)), axis=1)
X_test_single_2 = np.concatenate((data[:, 1:3].astype(int), data[:, 4:5].astype(int), data[:, 6:12].astype(int)), axis=1)
X_test_single_3 = np.concatenate((data[:, 1:2].astype(int), data[:, 3:6].astype(int), data[:, 7:12].astype(int)), axis=1)
X_test_single_4 = np.concatenate((data[:, 1:2].astype(int), data[:, 3:5].astype(int), data[:, 6:12].astype(int)), axis=1)
