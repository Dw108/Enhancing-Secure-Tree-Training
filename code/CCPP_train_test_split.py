...
# 无重叠数据
with open("../dataset/CCPP/pokerhand_train.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name)
    csv_writer.writerows(arr_train)
    f.close()
with open("../dataset/CCPP/pokerhand_validate.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name)
    csv_writer.writerows(arr_validate)
    f.close()
with open("../dataset/CCPP/pokerhand_test.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name)
...
with open("../dataset/CCPP/pokerhand_sub_feature_train.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name_feature)
    csv_writer.writerows(train_sub_feature)
    f.close()
with open("../dataset/CCPP/pokerhand_sub_feature_validate.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name_feature)
    csv_writer.writerows(validate_sub_feature)
    f.close()
with open("../dataset/CCPP/pokerhand_sub_feature_test.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name_feature)
...
with open("../dataset/CCPP/pokerhand_sub_item_train.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name)
    csv_writer.writerows(arr_train)
    f.close()
with open("../dataset/CCPP/pokerhand_sub_item_validate.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name)
    csv_writer.writerows(arr_validate)
    f.close()

with open("../dataset/CCPP/pokerhand_sub_item_test.csv", "w", encoding="utf-8", newline="") as f:
    csv_writer = csv.writer(f)
    csv_writer.writerow(name)
    csv_writer.writerows(arr_test)
    f.close()
