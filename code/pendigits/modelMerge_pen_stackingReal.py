...
data = df.values
X_train_feature = data[:, 1:19].astype(int)
...
data = df.values
X_validate_feature = data[:, 1:19].astype(int)
...
data = df.values
X_test_feature = data[:, 1:19].astype(int)
...
df = read_csv("../../dataset/bias/"+name_file+"/"+name_file+"_sub_feature_train" + enc + scale + ".csv")
data = df.values
X_train_single_1 = np.concatenate((data[:, 1:2].astype(int), data[:, 3:4].astype(int), data[:, 5:19].astype(int)),
                                  axis=1)
X_train_single_2 = np.concatenate((data[:, 1:2].astype(int), data[:, 4:5].astype(int), data[:, 5:19].astype(int)),
                                  axis=1)
X_train_single_3 = np.concatenate((data[:, 2:3].astype(int), data[:, 3:4].astype(int), data[:, 5:19].astype(int)),
                                  axis=1)
X_train_single_4 = np.concatenate((data[:, 2:3].astype(int), data[:, 4:5].astype(int), data[:, 5:19].astype(int)),
                                  axis=1)
...
df = read_csv("../../dataset/bias/"+name_file+"/"+name_file+"_sub_feature_validate" + enc + scale + ".csv")
data = df.values
X_validate_single_1 = np.concatenate((data[:, 1:2].astype(int), data[:, 3:4].astype(int), data[:, 5:19].astype(int)),
                                     axis=1)
X_validate_single_2 = np.concatenate((data[:, 1:2].astype(int), data[:, 4:5].astype(int), data[:, 5:19].astype(int)),
                                     axis=1)
X_validate_single_3 = np.concatenate((data[:, 2:3].astype(int), data[:, 3:4].astype(int), data[:, 5:19].astype(int)),
                                     axis=1)
X_validate_single_4 = np.concatenate((data[:, 2:3].astype(int), data[:, 4:5].astype(int), data[:, 5:19].astype(int)),
                                     axis=1)
...
df = read_csv("../../dataset/bias/"+name_file+"/"+name_file+"_sub_feature_test" + enc + scale + ".csv")
data = df.values
X_test_single_1 = np.concatenate((data[:, 1:2].astype(int), data[:, 3:4].astype(int), data[:, 5:19].astype(int)),
                                 axis=1)
X_test_single_2 = np.concatenate((data[:, 1:2].astype(int), data[:, 4:5].astype(int), data[:, 5:19].astype(int)),
                                 axis=1)
X_test_single_3 = np.concatenate((data[:, 2:3].astype(int), data[:, 3:4].astype(int), data[:, 5:19].astype(int)),
                                 axis=1)
X_test_single_4 = np.concatenate((data[:, 2:3].astype(int), data[:, 4:5].astype(int), data[:, 5:19].astype(int)),
                                 axis=1)
