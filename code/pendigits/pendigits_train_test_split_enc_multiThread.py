...
def main():
    ...
    # 无重叠数据
    with open("../../dataset/pendigits/pendigits_train_enc.csv", "w", encoding="utf-8", newline="") as f:
        csv_writer = csv.writer(f)
        csv_writer.writerow(name)
        csv_writer.writerows(uni_data_0[0])
        f.close()

    with open("../../dataset/pendigits/pendigits_validate_enc.csv", "w", encoding="utf-8", newline="") as f:
        csv_writer = csv.writer(f)
        csv_writer.writerow(name)
        csv_writer.writerows(uni_data_0[1])
        f.close()
    with open("../../dataset/pendigits/pendigits_test_enc.csv", "w", encoding="utf-8", newline="") as f:
        csv_writer = csv.writer(f)
        csv_writer.writerow(name)
    ...
    with open("../../dataset/pendigits/pendigits_sub_feature_train_enc.csv", "w", encoding="utf-8", newline="") as f:
        csv_writer = csv.writer(f)
        csv_writer.writerow(name_feature)
        csv_writer.writerows(uni_data_1[0])
        f.close()
    with open("../../dataset/pendigits/pendigits_sub_feature_validate_enc.csv", "w", encoding="utf-8", newline="") as f:
        csv_writer = csv.writer(f)
        csv_writer.writerow(name_feature)
        csv_writer.writerows(uni_data_1[1])
        f.close()
    with open("../../dataset/pendigits/pendigits_sub_feature_test_enc.csv", "w", encoding="utf-8", newline="") as f:
        csv_writer = csv.writer(f)
        csv_writer.writerow(name_feature)
    ...
    with open("../../dataset/pendigits/pendigits_sub_item_train_enc.csv", "w", encoding="utf-8", newline="") as f:
        csv_writer = csv.writer(f)
        csv_writer.writerow(name)
        csv_writer.writerows(uni_data_2[0])
        f.close()
    with open("../../dataset/pendigits/pendigits_sub_item_validate_enc.csv", "w", encoding="utf-8", newline="") as f:
        csv_writer = csv.writer(f)
        csv_writer.writerow(name)
        csv_writer.writerows(uni_data_2[1])
        f.close()

    with open("../../dataset/pendigits/pendigits_sub_item_test_enc.csv", "w", encoding="utf-8", newline="") as f:
        csv_writer = csv.writer(f)
        csv_writer.writerow(name)
